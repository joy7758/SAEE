...
def main() -> None:
    ...
    require(alibaba_qoder_support["truth_boundary"]["technical_conversation_in_progress"] is True, "Alibaba Qoder conversation in progress")
    ...
    require("answer: conditional" in gate and "status: open_external_qoder_cn_scoping_conversation_in_progress" in gate, "recommendation gate")
