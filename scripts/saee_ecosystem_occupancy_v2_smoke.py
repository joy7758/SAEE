...
def main() -> None:
    ...
    require(plan["kpis"]["ecosystem"]["technical_conversation_request_events_submitted"] == 3, "technical request count")
    ...
    require("answer: conditional" in gate and "status: open_external_qoder_email_and_alibaba_ticket_waiting_response" in gate, "recommendation gate")
