...
def main() -> None:
    ...
    require(plan["kpis"]["ecosystem"]["cloud_vendor_technical_conversation_in_progress"] == 0, "technical conversation in-progress count")
    ...
    require("answer: conditional" in gate and "status: open_external_qoder_business_handoff_pending_contact" in gate, "recommendation gate")
