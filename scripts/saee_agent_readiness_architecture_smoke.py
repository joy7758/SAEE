...
def validate(manifest: dict[str, Any]) -> dict[str, Any]:
    ...
    require(truth["evaluate_agent_run_available"] is True, "Agent Capability Alpha hidden")
    ...
    require(truth["evaluate_agent_run_mcp_tool_registered"] is True, "MCP Tool registration hidden")
...
def main() -> None:
    ...
    mutation = copy.deepcopy(manifest); mutation["current_truth"]["evaluate_agent_run_available"] = False; invalid.append((mutation, "hidden Alpha"))
    ...
    print("evaluate_agent_run_mcp_tool_registered=true")
