...
def main() -> None:
    ...
    require(capability["saee_evaluate_rehearsal_run_capability_v0_1"] is True, "capability marker missing")
    require(capability["capability_id"] == "internal.saee.evaluate_rehearsal_run", "capability id invalid")
