...
def main() -> None:
    ...
    requirements = [
        ...
        requirement("R15", "Complete two cloud-vendor technical conversations", ecosystem["cloud_vendor_technical_conversation_completed"] >= ecosystem["cloud_vendor_technical_conversation_target"], ["agent-interface/ecosystem/saee-cloud-technical-conversation-brief.v1.json", "agent-interface/ecosystem/saee-qoder-global-partner-application-submission-receipt.v1.json"], f"completed={ecosystem['cloud_vendor_technical_conversation_completed']}/{ecosystem['cloud_vendor_technical_conversation_target']}; the Qoder application is submitted but is not a conversation."),
        ...
        requirement("R22", "Enter an approved cloud marketplace route", package["truth_boundary"]["marketplace_listed"], ["agent-interface/ecosystem/saee-multi-cloud-partner-entry-matrix.v1.json"], "Alibaba product-partner application is under review; marketplace submission/listing remain false."),
