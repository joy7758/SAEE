...
def main() -> None:
    ...
    requirements = [
        ...
        requirement("R05", "Validate a Qoder process invoking SAEE", technical["qoder_process_invocation_validated"], ["adapters/qoder/README.md", "agent-interface/ecosystem/saee-qoder-cli-installation-preflight.v1.json"], "Qoder CLI is absent. The official installer and bounded validation sequence are inspected and ready, but installation and login remain behind explicit owner authorization; no Qoder process receipt exists."),
