#!/usr/bin/env python3
"""Smoke check for SAEE Phase 1 identity/tenant gap audit."""
...
REPORT_PATH = (
    ROOT
    / "phase_b_product/commercial_readiness/phase_1_identity_tenant_gap_audit/phase_1_identity_tenant_gap_audit.md"
)
CSV_PATH = (
    ROOT
...
README_PATH = (
    ROOT / "phase_b_product/commercial_readiness/phase_1_identity_tenant_gap_audit/README.md"
)
DOC_PATH = ROOT / "phase_b_product/commercial_readiness/PHASE_1_IDENTITY_TENANT_GAP_AUDIT_V0_1.md"
GATE_PATH = (
    ROOT / "docs/strategy/SAEE_PHASE_1_IDENTITY_TENANT_GAP_AUDIT_RECOMMENDATION_GATE.md"
)


def fail(message: str) -> None:
    print(f"SAEE_PHASE1_IDENTITY_TENANT_GAP_AUDIT_SMOKE: FAIL {message}", file=sys.stderr)
    raise SystemExit(1)
...
def main() -> None:
    ...
    require(
        audit.get("audit_type") == "saee_phase_1_identity_tenant_gap_audit",
        "wrong audit type",
    )
    require(
        audit.get("audit_scope") == "local_public_shell_to_production_evidence_gap_review",
        "wrong audit scope",
    )
    ...
    print(
        "SAEE_PHASE1_IDENTITY_TENANT_GAP_AUDIT_SMOKE: PASS "
