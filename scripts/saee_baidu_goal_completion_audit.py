...
def main() -> None:
    ...
    requirements = [
        ...
        requirement("R14", "Execute the 90-day route", "partially_achieved", ["docs/ecosystem/SAEE_BAIDU_90_DAY_EXECUTION_BOARD_V1.md"], "Local technical/material work, local baseline commit and real-provider synthetic roundtrips are complete; public Release, community/article publication and Baidu submission remain incomplete."),
