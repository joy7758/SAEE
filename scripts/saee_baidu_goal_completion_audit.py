...
def main() -> None:
    ...
    requirements = [
        ...
        requirement("R14", "Execute the 90-day route", "partially_achieved_waiting_baidu_response_and_publication_authorization", ["docs/ecosystem/SAEE_BAIDU_90_DAY_EXECUTION_BOARD_V1.md", "agent-interface/ecosystem/saee-baidu-partner-response-tracker.v1.json"], "Local technical/material work, commits, real-provider synthetic roundtrips, partner consultation submission, response tracker, public-demo package and technical-article draft are complete; Baidu response and external publication remain incomplete."),
