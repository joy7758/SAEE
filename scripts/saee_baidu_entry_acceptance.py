...
def main() -> None:
    ...
    if gate["authorization"]["approved"] is not False or gate["truth_boundary"]["marketplace_submission"] is not False:
    ...
    print(
        "SAEE_BAIDU_ENTRY_ACCEPTANCE: PASS local_phases_complete=4 checks=6 "
        "real_qianfan_product_roundtrip=false github_release=false "
