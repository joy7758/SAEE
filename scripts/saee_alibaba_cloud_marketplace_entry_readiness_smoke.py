...
def main() -> None:
    ...
    require(readiness["marketplace_console_observations"]["current_handoff_surface"] == "marketplace_product_business_info_next_step_pending_confirmation", "marketplace handoff")
    ...
    require(readiness["marketplace_console_observations"]["marketplace_product_validity_owner_approved"] is False, "validity approval boundary")
    ...
    require(readiness["marketplace_console_observations"]["marketplace_product_sales_information_saved"] is False, "sales information save boundary")
    ...
    require(truth["marketplace_product_sales_information_saved"] is False, "sales information save truth boundary")
    ...
    require(listing["initial_sku"]["validity_owner_approved"] is False, "validity approval boundary")
    ...
    require(listing["truth_boundary"]["marketplace_product_submission"] is False, "listing submission boundary")
    ...
    require(store_profile["truth_boundary"]["marketplace_product_submission"] is False, "store profile product submission boundary")
    ...
    serialized = "\n".join(
        ...
        for path in (READINESS, LISTING, PROPOSAL, SOP, STORE_PROFILE, GATE, PACKAGE / "README.md")
    )
    ...
    print(
        ...
        "business_info_saved=true sales_information_opened=true sales_information_form_fields_entered=true sales_information_saved=false public_price_points_approved=true validity_owner_approved=false customer_input_adapter_ready=true architecture_uploaded=true certification_applications=0 local_listing_package=true marketplace_submission=false "
