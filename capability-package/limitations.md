# SAEE Capability Service Package v1.0 限制
...
- `mcp-tool.json` 不是 MCP Server，也不证明标准 MCP 互操作。
- Package 不建立安全、合规、法律、认证、部署批准或真实世界风险概率。
- Package 不建立客户验证、外部采用、市场验证、云市场收录或收入事实。
- Package 不执行 Agent、外部工具、未知代码或外部世界动作。
